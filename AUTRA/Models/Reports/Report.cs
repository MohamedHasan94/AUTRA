   ...
   public class Report
    {
        ...
        private void CreateTableFromGroup(Group group , Document doc)
        {
            ...
            foreach (var beam in group.Beams)
            {
                ...
                Cell cell5 = new Cell(1, 1).AddOrdinaryCell(beam.CombinedSA[0].Stations[0].Mo.ToString());
                Cell cell6 = new Cell(1, 1).AddOrdinaryCell(beam.CombinedSA[0].GetMaxShear().ToString());
                cells.Add(cell1);
                cells.Add(cell2);
                cells.Add(cell3);
                cells.Add(cell4);
